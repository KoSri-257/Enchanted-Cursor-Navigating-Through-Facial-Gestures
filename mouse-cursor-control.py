...
shape_predictor = r"C:\Users\HOME\Desktop\Projects\IOMP\new\shape_predictor_68_face_landmarks.dat"
...
while True:
    ...
    cv2.putText(frame, "Diff EAR: {:.2f}".format(np.abs(leftEAR - rightEAR)), (460, 80), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
